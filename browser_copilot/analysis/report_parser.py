...
class ReportParser:
    ...
    def check_success(report_content: str) -> bool:
        ...
        if any(indicator in content_lower for indicator in [
            "error:", "failed:", "failure:", "exception:", "assertion error"
        ]):
            return False
        ...
        for step in steps:
            ...
            if agent_messages or tools_called:
                execution_steps.append(
                    ExecutionStep(
                        action=' '.join(agent_messages) if agent_messages else 'Tool execution',
                        result=f"Tools used: {', '.join(tools_called)}" if tools_called else "Completed",
    ...
    @staticmethod
    def extract_error_message(report_content: str) -> Optional[str]:
        """
    ...
    @staticmethod
    def extract_test_duration(report_content: str) -> Optional[float]:
        """
