...
from .base import Message, MessageType, MessageImportance
...
class MessageAnalyzer:
    ...
    def get_content_type(self, message: Message) -> str:
        ...
        if 'snapshot' in content_lower or 'dom tree' in content_lower:
            ...
            return 'navigation'
        elif any(word in content_lower for word in ['click', 'type', 'submit', 'select']):
            return 'interaction'
...
class ImportanceScorer:
    ...
    def score_message(self, message: Message, context: Optional[list[Message]] = None) -> float:
        """
        ...
        final_score = base_score + recency_boost + error_boost + tool_boost + length_penalty
