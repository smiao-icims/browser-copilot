...
class Message:
    ...
    def __post_init__(self):
        ...
        elif self.type in (MessageType.TOOL_RESPONSE, MessageType.SYSTEM) and self.importance == MessageImportance.MEDIUM:
            self.importance = MessageImportance.HIGH
        elif self.type == MessageType.TOOL_CALL and self.importance == MessageImportance.MEDIUM:
            self.importance = MessageImportance.HIGH
