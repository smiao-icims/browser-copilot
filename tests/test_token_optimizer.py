...
from token_optimizer import TokenOptimizer, OptimizationLevel, OptimizationPresets
...
class TestTokenOptimizer:
    ...
    def test_optimization_levels(self):
        ...
        assert metrics['reduction_percentage'] > 20  # Should achieve at least 20% reduction
    ...
    def test_selector_preservation(self):
        ...
        for test in test_cases:
            ...
            has_selector = any(selector in result for selector in [".submit", "#login", "input[", "button.", ".primary"])
    ...
    def test_optimization_presets(self):
        ...
        assert unknown_preset['level'] == OptimizationLevel.MEDIUM  # Falls back to balanced
    ...
    def test_langchain_message_optimization(self, mock_langchain_imports):
        ...
        messages = [
            ...
            HumanMessage(content="Please navigate to the website and click on the button"),
