...
class TokenOptimizer:
    ...
    FILLER_WORDS = {
        ...
        "before", "after", "above", "below", "between", "under", "since", "without",
    ...
    def optimize_prompt(self, prompt: str) -> str:
        ...
        if self.level in [OptimizationLevel.LOW, OptimizationLevel.MEDIUM, OptimizationLevel.HIGH]:
    ...
    def optimize_context(
        ...
        recent_content = context[-preserve_recent:] if len(context) > preserve_recent else context
    ...
    def _remove_redundant_words(self, text: str) -> str:
        ...
        text = re.sub(r'\b(very|really|quite|extremely)\s+', '', text, flags=re.IGNORECASE)
    ...
    def _remove_filler_words(self, text: str) -> str:
        ...
        for i, word in enumerate(words):
            ...
            if word.lower() not in self.FILLER_WORDS or self._is_critical_context(words, i):
    ...
    def _compress_instructions(self, text: str) -> str:
        ...
        text = re.sub(r'^(You should|You must|You need to)\s+', '', text, flags=re.MULTILINE | re.IGNORECASE)
        return text
    ...
    def _update_metrics(self, original: int, optimized: int, strategies: List[str]) -> None:
