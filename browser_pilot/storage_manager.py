...
class StorageManager:
    ...
    def get_setting(self, key: str, default: Any = None, settings_file: str = "config") -> Any:
        """
    ...
    def cleanup_old_files(self, directory: Union[str, Path], pattern: str = "*", days: int = 7) -> int:
        """
