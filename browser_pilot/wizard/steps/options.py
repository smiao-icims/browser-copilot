...
class TestModeStep(WizardStep):
    ...
    async def execute(self, state: WizardState) -> StepResult:
        ...
        choices = [
            Choice(
                title="headless    (Faster, no browser window)",
                value=True
            ),
            Choice(
                title="headed      (See browser actions)",
                value=False
            ),
        ]
...
class TokenOptimizationStep(WizardStep):
    ...
    async def execute(self, state: WizardState) -> StepResult:
        ...
        choices = [
            Choice(
                title="medium      (Balanced - 20% reduction)",
                value="medium"
            ),
            Choice(
                title="high        (Maximum savings - 30% reduction)",
                value="high"
            ),
            Choice(
                title="low         (Conservative - 10% reduction)",
                value="low"
            ),
            Choice(
                title="none        (No optimization)",
                value="none"
            ),
        ]
