...
class ModelSelectionStep(WizardStep):
    ...
    PROVIDER_MODELS = {
        "github_copilot": [
            {"name": "gpt-4o", "description": "Recommended - Best performance", "context": "128k"},
            {"name": "gpt-4", "description": "Previous generation", "context": "8k"},
            {"name": "gpt-3.5-turbo", "description": "Faster, lower cost", "context": "16k"},
            {"name": "claude-3-sonnet", "description": "Alternative model", "context": "200k"},
        ],
        "openai": [
            {"name": "gpt-4o", "description": "Latest and most capable", "context": "128k"},
            {"name": "gpt-4-turbo", "description": "High performance", "context": "128k"},
            {"name": "gpt-4", "description": "Stable version", "context": "8k"},
            {"name": "gpt-3.5-turbo", "description": "Fast and cost-effective", "context": "16k"},
        ],
        "anthropic": [
            {"name": "claude-3-opus-20240229", "description": "Most capable", "context": "200k"},
            {"name": "claude-3-sonnet-20240229", "description": "Balanced performance", "context": "200k"},
            {"name": "claude-3-haiku-20240307", "description": "Fast and efficient", "context": "200k"},
        ],
        "google": [
            {"name": "gemini-1.5-pro", "description": "Latest Gemini model", "context": "1M"},
            {"name": "gemini-1.5-flash", "description": "Fast variant", "context": "1M"},
            {"name": "gemini-pro", "description": "Previous generation", "context": "32k"},
        ],
        "azure": [
            {"name": "gpt-4", "description": "GPT-4 on Azure", "context": "8k"},
            {"name": "gpt-35-turbo", "description": "GPT-3.5 on Azure", "context": "16k"},
        ],
        "local": [
    ...
    async def _get_models_from_modelforge(self, provider: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"⚠️  ModelForge v2.2.2+ required for model discovery")
            return self._get_fallback_models(provider)
        except Exception as e:
